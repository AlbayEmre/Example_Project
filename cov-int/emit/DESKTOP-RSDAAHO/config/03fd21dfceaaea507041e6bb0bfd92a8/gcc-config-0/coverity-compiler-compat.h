...
#if __COVERITY__
#if !defined(COVERITY_COMPAT_6350b46693a1a6948fad3c307ec46552)
#define COVERITY_COMPAT_6350b46693a1a6948fad3c307ec46552
...
#if __GNUC__ >= 10
// Starting with GCC 10, __bf16 type is available
#define __COVERITY_GCC_BF16_INTRINSICS 1
#else
#define __COVERITY_GCC_BF16_INTRINSICS 0
#endif /* __GNUC__ >= 10 */

#if __GNUC__ >= 6
// Starting with GCC 6, __fp16 type is available
#define __COVERITY_GCC_FP16_INTRINSICS 1
#else
#define __COVERITY_GCC_FP16_INTRINSICS 0
#endif /* __GNUC__ >= 6 */
...
#if __COVERITY_GCC_BF16_INTRINSICS
...
#endif /* __COVERITY_GCC_BF16_INTRINSICS */
...
#if __COVERITY_GCC_FP16_INTRINSICS
...
#endif /* __COVERITY_GCC_FP16_INTRINSICS */
...
#if __COVERITY_GCC_VERSION_AT_LEAST(13, 1)
#ifdef __coverity_cplusplus
typedef __complex__ _Float16 __coverity_float __coverity_complex_float16;
typedef __complex__ _Float32 __coverity_complex_float32;
typedef __complex__ _Float32x  __coverity_complex_float32x;
typedef __complex__ _Float64  __coverity_complex_float64;
typedef __complex__ _Float64x __coverity_complex_float64x;
typedef __complex__ _Float128 __coverity_complex_float128;

_Float16 __builtin_acoshf16(_Float16);
_Float32 __builtin_acoshf32(_Float32);
_Float64 __builtin_acoshf64(_Float64);
_Float128 __builtin_acoshf128(_Float128);
_Float32x __builtin_acoshf32x(_Float32x);
_Float64x __builtin_acoshf64x(_Float64x);
_Float128 __builtin_acoshf128x(_Float128);
_Float16 __builtin_acosf16(_Float16);
_Float32 __builtin_acosf32(_Float32);
_Float64 __builtin_acosf64(_Float64);
_Float128 __builtin_acosf128(_Float128);
_Float32x __builtin_acosf32x(_Float32x);
_Float64x __builtin_acosf64x(_Float64x);
_Float128 __builtin_acosf128x(_Float128);
_Float16 __builtin_asinhf16(_Float16);
_Float32 __builtin_asinhf32(_Float32);
_Float64 __builtin_asinhf64(_Float64);
_Float128 __builtin_asinhf128(_Float128);
_Float32x __builtin_asinhf32x(_Float32x);
_Float64x __builtin_asinhf64x(_Float64x);
_Float128 __builtin_asinhf128x(_Float128);
_Float16 __builtin_asinf16(_Float16);
_Float32 __builtin_asinf32(_Float32);
_Float64 __builtin_asinf64(_Float64);
_Float128 __builtin_asinf128(_Float128);
_Float32x __builtin_asinf32x(_Float32x);
_Float64x __builtin_asinf64x(_Float64x);
_Float128 __builtin_asinf128x(_Float128);
_Float16 __builtin_atan2f16(_Float16, _Float16);
_Float32 __builtin_atan2f32(_Float32, _Float32);
_Float64 __builtin_atan2f64(_Float64, _Float64);
_Float128 __builtin_atan2f128(_Float128, _Float128);
_Float32x __builtin_atan2f32x(_Float32x, _Float32x);
_Float64x __builtin_atan2f64x(_Float64x, _Float64x);
_Float128 __builtin_atan2f128x(_Float128, _Float128);
_Float16 __builtin_atanhf16(_Float16);
_Float32 __builtin_atanhf32(_Float32);
_Float64 __builtin_atanhf64(_Float64);
_Float128 __builtin_atanhf128(_Float128);
_Float32x __builtin_atanhf32x(_Float32x);
_Float64x __builtin_atanhf64x(_Float64x);
_Float128 __builtin_atanhf128x(_Float128);
_Float16 __builtin_atanf16(_Float16);
_Float32 __builtin_atanf32(_Float32);
_Float64 __builtin_atanf64(_Float64);
_Float128 __builtin_atanf128(_Float128);
_Float32x __builtin_atanf32x(_Float32x);
_Float64x __builtin_atanf64x(_Float64x);
_Float128 __builtin_atanf128x(_Float128);
_Float16 __builtin_cbrtf16(_Float16);
_Float32 __builtin_cbrtf32(_Float32);
_Float64 __builtin_cbrtf64(_Float64);
_Float128 __builtin_cbrtf128(_Float128);
_Float32x __builtin_cbrtf32x(_Float32x);
_Float64x __builtin_cbrtf64x(_Float64x);
_Float128 __builtin_cbrtf128x(_Float128);
_Float16 __builtin_coshf16(_Float16);
_Float32 __builtin_coshf32(_Float32);
_Float64 __builtin_coshf64(_Float64);
_Float128 __builtin_coshf128(_Float128);
_Float32x __builtin_coshf32x(_Float32x);
_Float64x __builtin_coshf64x(_Float64x);
_Float128 __builtin_coshf128x(_Float128);
_Float16 __builtin_cosf16(_Float16);
_Float32 __builtin_cosf32(_Float32);
_Float64 __builtin_cosf64(_Float64);
_Float128 __builtin_cosf128(_Float128);
_Float32x __builtin_cosf32x(_Float32x);
_Float64x __builtin_cosf64x(_Float64x);
_Float128 __builtin_cosf128x(_Float128);
_Float16 __builtin_erfcf16(_Float16);
_Float32 __builtin_erfcf32(_Float32);
_Float64 __builtin_erfcf64(_Float64);
_Float128 __builtin_erfcf128(_Float128);
_Float32x __builtin_erfcf32x(_Float32x);
_Float64x __builtin_erfcf64x(_Float64x);
_Float128 __builtin_erfcf128x(_Float128);
_Float16 __builtin_erff16(_Float16);
_Float32 __builtin_erff32(_Float32);
_Float64 __builtin_erff64(_Float64);
_Float128 __builtin_erff128(_Float128);
_Float32x __builtin_erff32x(_Float32x);
_Float64x __builtin_erff64x(_Float64x);
_Float128 __builtin_erff128x(_Float128);
_Float16 __builtin_exp2f16(_Float16);
_Float32 __builtin_exp2f32(_Float32);
_Float64 __builtin_exp2f64(_Float64);
_Float128 __builtin_exp2f128(_Float128);
_Float32x __builtin_exp2f32x(_Float32x);
_Float64x __builtin_exp2f64x(_Float64x);
_Float128 __builtin_exp2f128x(_Float128);
_Float16 __builtin_expf16(_Float16);
_Float32 __builtin_expf32(_Float32);
_Float64 __builtin_expf64(_Float64);
_Float128 __builtin_expf128(_Float128);
_Float32x __builtin_expf32x(_Float32x);
_Float64x __builtin_expf64x(_Float64x);
_Float128 __builtin_expf128x(_Float128);
_Float16 __builtin_expm1f16(_Float16);
_Float32 __builtin_expm1f32(_Float32);
_Float64 __builtin_expm1f64(_Float64);
_Float128 __builtin_expm1f128(_Float128);
_Float32x __builtin_expm1f32x(_Float32x);
_Float64x __builtin_expm1f64x(_Float64x);
_Float128 __builtin_expm1f128x(_Float128);
_Float16 __builtin_fdimf16(_Float16, _Float16);
_Float32 __builtin_fdimf32(_Float32, _Float32);
_Float64 __builtin_fdimf64(_Float64, _Float64);
_Float128 __builtin_fdimf128(_Float128, _Float128);
_Float32x __builtin_fdimf32x(_Float32x, _Float32x);
_Float64x __builtin_fdimf64x(_Float64x, _Float64x);
_Float128 __builtin_fdimf128x(_Float128, _Float128);
_Float16 __builtin_fmodf16(_Float16, _Float16);
_Float32 __builtin_fmodf32(_Float32, _Float32);
_Float64 __builtin_fmodf64(_Float64, _Float64);
_Float128 __builtin_fmodf128(_Float128, _Float128);
_Float32x __builtin_fmodf32x(_Float32x, _Float32x);
_Float64x __builtin_fmodf64x(_Float64x, _Float64x);
_Float128 __builtin_fmodf128x(_Float128, _Float128);
_Float16 __builtin_frexpf16(_Float16, double);
_Float32 __builtin_frexpf32(_Float32, double);
_Float64 __builtin_frexpf64(_Float64, double);
_Float128 __builtin_frexpf128(_Float128, double);
_Float32x __builtin_frexpf32x(_Float32x, double);
_Float64x __builtin_frexpf64x(_Float64x, double);
_Float128 __builtin_frexpf128x(_Float128, double);
_Float16 __builtin_hypotf16(_Float16, _Float16);
_Float32 __builtin_hypotf32(_Float32, _Float32);
_Float64 __builtin_hypotf64(_Float64, _Float64);
_Float128 __builtin_hypotf128(_Float128, _Float128);
_Float32x __builtin_hypotf32x(_Float32x, _Float32x);
_Float64x __builtin_hypotf64x(_Float64x, _Float64x);
_Float128 __builtin_hypotf128x(_Float128, _Float128);
int __builtin_ilogbf16(_Float16);
int __builtin_ilogbf32(_Float32);
int __builtin_ilogbf64(_Float64);
int __builtin_ilogbf128(_Float128);
int __builtin_ilogbf32x(_Float32x);
int __builtin_ilogbf64x(_Float64x);
int __builtin_ilogbf128x(_Float128);
_Float16 __builtin_ldexpf16(_Float16, int);
_Float32 __builtin_ldexpf32(_Float32, int);
_Float64 __builtin_ldexpf64(_Float64, int);
_Float128 __builtin_ldexpf128(_Float128, int);
_Float32x __builtin_ldexpf32x(_Float32x, int);
_Float64x __builtin_ldexpf64x(_Float64x, int);
_Float128 __builtin_ldexpf128x(_Float128, int);
_Float16 __builtin_lgammaf16(_Float16);
_Float32 __builtin_lgammaf32(_Float32);
_Float64 __builtin_lgammaf64(_Float64);
_Float128 __builtin_lgammaf128(_Float128);
_Float32x __builtin_lgammaf32x(_Float32x);
_Float64x __builtin_lgammaf64x(_Float64x);
_Float128 __builtin_lgammaf128x(_Float128);
long long __builtin_llrintf16(_Float16);
long long __builtin_llrintf32(_Float32);
long long __builtin_llrintf64(_Float64);
long long __builtin_llrintf128(_Float128);
long long __builtin_llrintf32x(_Float32x);
long long __builtin_llrintf64x(_Float64x);
long long __builtin_llrintf128x(_Float128);
long long __builtin_llroundf16(_Float16);
long long __builtin_llroundf32(_Float32);
long long __builtin_llroundf64(_Float64);
long long __builtin_llroundf128(_Float128);
long long __builtin_llroundf32x(_Float32x);
long long __builtin_llroundf64x(_Float64x);
long long __builtin_llroundf128x(_Float128);
_Float16 __builtin_log10f16(_Float16);
_Float32 __builtin_log10f32(_Float32);
_Float64 __builtin_log10f64(_Float64);
_Float128 __builtin_log10f128(_Float128);
_Float32x __builtin_log10f32x(_Float32x);
_Float64x __builtin_log10f64x(_Float64x);
_Float128 __builtin_log10f128x(_Float128);
_Float16 __builtin_log1pf16(_Float16);
_Float32 __builtin_log1pf32(_Float32);
_Float64 __builtin_log1pf64(_Float64);
_Float128 __builtin_log1pf128(_Float128);
_Float32x __builtin_log1pf32x(_Float32x);
_Float64x __builtin_log1pf64x(_Float64x);
_Float128 __builtin_log1pf128x(_Float128);
_Float16 __builtin_log2f16(_Float16);
_Float32 __builtin_log2f32(_Float32);
_Float64 __builtin_log2f64(_Float64);
_Float128 __builtin_log2f128(_Float128);
_Float32x __builtin_log2f32x(_Float32x);
_Float64x __builtin_log2f64x(_Float64x);
_Float128 __builtin_log2f128x(_Float128);
_Float16 __builtin_logbf16(_Float16);
_Float32 __builtin_logbf32(_Float32);
_Float64 __builtin_logbf64(_Float64);
_Float128 __builtin_logbf128(_Float128);
_Float32x __builtin_logbf32x(_Float32x);
_Float64x __builtin_logbf64x(_Float64x);
_Float128 __builtin_logbf128x(_Float128);
_Float16 __builtin_logf16(_Float16);
_Float32 __builtin_logf32(_Float32);
_Float64 __builtin_logf64(_Float64);
_Float128 __builtin_logf128(_Float128);
_Float32x __builtin_logf32x(_Float32x);
_Float64x __builtin_logf64x(_Float64x);
_Float128 __builtin_logf128x(_Float128);
long __builtin_lrintf16(_Float16);
long __builtin_lrintf32(_Float32);
long __builtin_lrintf64(_Float64);
long __builtin_lrintf128(_Float128);
long __builtin_lrintf32x(_Float32x);
long __builtin_lrintf64x(_Float64x);
long __builtin_lrintf128x(_Float128);
long __builtin_lroundf16(_Float16);
long __builtin_lroundf32(_Float32);
long __builtin_lroundf64(_Float64);
long __builtin_lroundf128(_Float128);
long __builtin_lroundf32x(_Float32x);
long __builtin_lroundf64x(_Float64x);
long __builtin_lroundf128x(_Float128);
_Float16 __builtin_modff16(_Float16, _Float16);
_Float32 __builtin_modff32(_Float32, _Float32);
_Float64 __builtin_modff64(_Float64, _Float64);
_Float128 __builtin_modff128(_Float128, _Float128);
_Float32x __builtin_modff32x(_Float32x, _Float32x);
_Float64x __builtin_modff64x(_Float64x, _Float64x);
_Float128 __builtin_modff128x(_Float128, _Float128);
_Float16 __builtin_nextafterf16(_Float16, _Float16);
_Float32 __builtin_nextafterf32(_Float32, _Float32);
_Float64 __builtin_nextafterf64(_Float64, _Float64);
_Float128 __builtin_nextafterf128(_Float128, _Float128);
_Float32x __builtin_nextafterf32x(_Float32x, _Float32x);
_Float64x __builtin_nextafterf64x(_Float64x, _Float64x);
_Float128 __builtin_nextafterf128x(_Float128, _Float128);
_Float16 __builtin_powf16(_Float16, _Float16);
_Float32 __builtin_powf32(_Float32, _Float32);
_Float64 __builtin_powf64(_Float64, _Float64);
_Float128 __builtin_powf128(_Float128, _Float128);
_Float32x __builtin_powf32x(_Float32x, _Float32x);
_Float64x __builtin_powf64x(_Float64x, _Float64x);
_Float128 __builtin_powf128x(_Float128, _Float128);
_Float16 __builtin_remainderf16(_Float16, _Float16);
_Float32 __builtin_remainderf32(_Float32, _Float32);
_Float64 __builtin_remainderf64(_Float64, _Float64);
_Float128 __builtin_remainderf128(_Float128, _Float128);
_Float32x __builtin_remainderf32x(_Float32x, _Float32x);
_Float64x __builtin_remainderf64x(_Float64x, _Float64x);
_Float128 __builtin_remainderf128x(_Float128, _Float128);
_Float16 __builtin_remquof16(_Float16, _Float16, double);
_Float32 __builtin_remquof32(_Float32, _Float32, double);
_Float64 __builtin_remquof64(_Float64, _Float64, double);
_Float128 __builtin_remquof128(_Float128, _Float128, double);
_Float32x __builtin_remquof32x(_Float32x, _Float32x, double);
_Float64x __builtin_remquof64x(_Float64x, _Float64x, double);
_Float128 __builtin_remquof128x(_Float128, _Float128, double);
_Float16 __builtin_scalblnf16(_Float16, long);
_Float32 __builtin_scalblnf32(_Float32, long);
_Float64 __builtin_scalblnf64(_Float64, long);
_Float128 __builtin_scalblnf128(_Float128, long);
_Float32x __builtin_scalblnf32x(_Float32x, long);
_Float64x __builtin_scalblnf64x(_Float64x, long);
_Float128 __builtin_scalblnf128x(_Float128, long);
_Float16 __builtin_scalbnf16(_Float16, int);
_Float32 __builtin_scalbnf32(_Float32, int);
_Float64 __builtin_scalbnf64(_Float64, int);
_Float128 __builtin_scalbnf128(_Float128, int);
_Float32x __builtin_scalbnf32x(_Float32x, int);
_Float64x __builtin_scalbnf64x(_Float64x, int);
_Float128 __builtin_scalbnf128x(_Float128, int);
_Float16 __builtin_sinhf16(_Float16);
_Float32 __builtin_sinhf32(_Float32);
_Float64 __builtin_sinhf64(_Float64);
_Float128 __builtin_sinhf128(_Float128);
_Float32x __builtin_sinhf32x(_Float32x);
_Float64x __builtin_sinhf64x(_Float64x);
_Float128 __builtin_sinhf128x(_Float128);
_Float16 __builtin_sinf16(_Float16);
_Float32 __builtin_sinf32(_Float32);
_Float64 __builtin_sinf64(_Float64);
_Float128 __builtin_sinf128(_Float128);
_Float32x __builtin_sinf32x(_Float32x);
_Float64x __builtin_sinf64x(_Float64x);
_Float128 __builtin_sinf128x(_Float128);
_Float16 __builtin_tanhf16(_Float16);
_Float32 __builtin_tanhf32(_Float32);
_Float64 __builtin_tanhf64(_Float64);
_Float128 __builtin_tanhf128(_Float128);
_Float32x __builtin_tanhf32x(_Float32x);
_Float64x __builtin_tanhf64x(_Float64x);
_Float128 __builtin_tanhf128x(_Float128);
_Float16 __builtin_tanf16(_Float16);
_Float32 __builtin_tanf32(_Float32);
_Float64 __builtin_tanf64(_Float64);
_Float128 __builtin_tanf128(_Float128);
_Float32x __builtin_tanf32x(_Float32x);
_Float64x __builtin_tanf64x(_Float64x);
_Float128 __builtin_tanf128x(_Float128);
_Float16 __builtin_tgammaf16(_Float16);
_Float32 __builtin_tgammaf32(_Float32);
_Float64 __builtin_tgammaf64(_Float64);
_Float128 __builtin_tgammaf128(_Float128);
_Float32x __builtin_tgammaf32x(_Float32x);
_Float64x __builtin_tgammaf64x(_Float64x);
_Float128 __builtin_tgammaf128x(_Float128);
_Float16 __builtin_cabsf16(__coverity_complex_float16);
_Float32 __builtin_cabsf32(__coverity_complex_float32);
_Float64 __builtin_cabsf64(__coverity_complex_float64);
_Float128 __builtin_cabsf128(__coverity_complex_float128);
_Float32x __builtin_cabsf32x(__coverity_complex_float32x);
_Float64x __builtin_cabsf64x(__coverity_complex_float64x);
_Float128 __builtin_cabsf128x(__coverity_complex_float128);
__coverity_complex_float16 __builtin_cacoshf16(__coverity_complex_float16);
__coverity_complex_float32 __builtin_cacoshf32(__coverity_complex_float32);
__coverity_complex_float64 __builtin_cacoshf64(__coverity_complex_float64);
__coverity_complex_float128 __builtin_cacoshf128(__coverity_complex_float128);
__coverity_complex_float32x __builtin_cacoshf32x(__coverity_complex_float32x);
__coverity_complex_float64x __builtin_cacoshf64x(__coverity_complex_float64x);
__coverity_complex_float128 __builtin_cacoshf128x(__coverity_complex_float128);
__coverity_complex_float16 __builtin_cacosf16(__coverity_complex_float16);
__coverity_complex_float32 __builtin_cacosf32(__coverity_complex_float32);
__coverity_complex_float64 __builtin_cacosf64(__coverity_complex_float64);
__coverity_complex_float128 __builtin_cacosf128(__coverity_complex_float128);
__coverity_complex_float32x __builtin_cacosf32x(__coverity_complex_float32x);
__coverity_complex_float64x __builtin_cacosf64x(__coverity_complex_float64x);
__coverity_complex_float128 __builtin_cacosf128x(__coverity_complex_float128);
_Float16 __builtin_cargf16(__coverity_complex_float16);
_Float32 __builtin_cargf32(__coverity_complex_float32);
_Float64 __builtin_cargf64(__coverity_complex_float64);
_Float128 __builtin_cargf128(__coverity_complex_float128);
_Float32x __builtin_cargf32x(__coverity_complex_float32x);
_Float64x __builtin_cargf64x(__coverity_complex_float64x);
_Float128 __builtin_cargf128x(__coverity_complex_float128);
__coverity_complex_float16 __builtin_casinhf16(__coverity_complex_float16);
__coverity_complex_float32 __builtin_casinhf32(__coverity_complex_float32);
__coverity_complex_float64 __builtin_casinhf64(__coverity_complex_float64);
__coverity_complex_float128 __builtin_casinhf128(__coverity_complex_float128);
__coverity_complex_float32x __builtin_casinhf32x(__coverity_complex_float32x);
__coverity_complex_float64x __builtin_casinhf64x(__coverity_complex_float64x);
__coverity_complex_float128 __builtin_casinhf128x(__coverity_complex_float128);
__coverity_complex_float16 __builtin_casinf16(__coverity_complex_float16);
__coverity_complex_float32 __builtin_casinf32(__coverity_complex_float32);
__coverity_complex_float64 __builtin_casinf64(__coverity_complex_float64);
__coverity_complex_float128 __builtin_casinf128(__coverity_complex_float128);
__coverity_complex_float32x __builtin_casinf32x(__coverity_complex_float32x);
__coverity_complex_float64x __builtin_casinf64x(__coverity_complex_float64x);
__coverity_complex_float128 __builtin_casinf128x(__coverity_complex_float128);
__coverity_complex_float16 __builtin_catanhf16(__coverity_complex_float16);
__coverity_complex_float32 __builtin_catanhf32(__coverity_complex_float32);
__coverity_complex_float64 __builtin_catanhf64(__coverity_complex_float64);
__coverity_complex_float128 __builtin_catanhf128(__coverity_complex_float128);
__coverity_complex_float32x __builtin_catanhf32x(__coverity_complex_float32x);
__coverity_complex_float64x __builtin_catanhf64x(__coverity_complex_float64x);
__coverity_complex_float128 __builtin_catanhf128x(__coverity_complex_float128);
__coverity_complex_float16 __builtin_catanf16(__coverity_complex_float16);
__coverity_complex_float32 __builtin_catanf32(__coverity_complex_float32);
__coverity_complex_float64 __builtin_catanf64(__coverity_complex_float64);
__coverity_complex_float128 __builtin_catanf128(__coverity_complex_float128);
__coverity_complex_float32x __builtin_catanf32x(__coverity_complex_float32x);
__coverity_complex_float64x __builtin_catanf64x(__coverity_complex_float64x);
__coverity_complex_float128 __builtin_catanf128x(__coverity_complex_float128);
__coverity_complex_float16 __builtin_ccoshf16(__coverity_complex_float16);
__coverity_complex_float32 __builtin_ccoshf32(__coverity_complex_float32);
__coverity_complex_float64 __builtin_ccoshf64(__coverity_complex_float64);
__coverity_complex_float128 __builtin_ccoshf128(__coverity_complex_float128);
__coverity_complex_float32x __builtin_ccoshf32x(__coverity_complex_float32x);
__coverity_complex_float64x __builtin_ccoshf64x(__coverity_complex_float64x);
__coverity_complex_float128 __builtin_ccoshf128x(__coverity_complex_float128);
__coverity_complex_float16 __builtin_ccosf16(__coverity_complex_float16);
__coverity_complex_float32 __builtin_ccosf32(__coverity_complex_float32);
__coverity_complex_float64 __builtin_ccosf64(__coverity_complex_float64);
__coverity_complex_float128 __builtin_ccosf128(__coverity_complex_float128);
__coverity_complex_float32x __builtin_ccosf32x(__coverity_complex_float32x);
__coverity_complex_float64x __builtin_ccosf64x(__coverity_complex_float64x);
__coverity_complex_float128 __builtin_ccosf128x(__coverity_complex_float128);
__coverity_complex_float16 __builtin_cexpf16(__coverity_complex_float16);
__coverity_complex_float32 __builtin_cexpf32(__coverity_complex_float32);
__coverity_complex_float64 __builtin_cexpf64(__coverity_complex_float64);
__coverity_complex_float128 __builtin_cexpf128(__coverity_complex_float128);
__coverity_complex_float32x __builtin_cexpf32x(__coverity_complex_float32x);
__coverity_complex_float64x __builtin_cexpf64x(__coverity_complex_float64x);
__coverity_complex_float128 __builtin_cexpf128x(__coverity_complex_float128);
__coverity_complex_float16 __builtin_clogf16(__coverity_complex_float16);
__coverity_complex_float32 __builtin_clogf32(__coverity_complex_float32);
__coverity_complex_float64 __builtin_clogf64(__coverity_complex_float64);
__coverity_complex_float128 __builtin_clogf128(__coverity_complex_float128);
__coverity_complex_float32x __builtin_clogf32x(__coverity_complex_float32x);
__coverity_complex_float64x __builtin_clogf64x(__coverity_complex_float64x);
__coverity_complex_float128 __builtin_clogf128x(__coverity_complex_float128);
__coverity_complex_float16 __builtin_cpowf16(__coverity_complex_float16, __coverity_complex_float16);
__coverity_complex_float32 __builtin_cpowf32(__coverity_complex_float32, __coverity_complex_float32);
__coverity_complex_float64 __builtin_cpowf64(__coverity_complex_float64, __coverity_complex_float64);
__coverity_complex_float128 __builtin_cpowf128(__coverity_complex_float128, __coverity_complex_float128);
__coverity_complex_float32x __builtin_cpowf32x(__coverity_complex_float32x, __coverity_complex_float32x);
__coverity_complex_float64x __builtin_cpowf64x(__coverity_complex_float64x, __coverity_complex_float64x);
__coverity_complex_float128 __builtin_cpowf128x(__coverity_complex_float128, __coverity_complex_float128);
__coverity_complex_float16 __builtin_cprojf16(__coverity_complex_float16);
__coverity_complex_float32 __builtin_cprojf32(__coverity_complex_float32);
__coverity_complex_float64 __builtin_cprojf64(__coverity_complex_float64);
__coverity_complex_float128 __builtin_cprojf128(__coverity_complex_float128);
__coverity_complex_float32x __builtin_cprojf32x(__coverity_complex_float32x);
__coverity_complex_float64x __builtin_cprojf64x(__coverity_complex_float64x);
__coverity_complex_float128 __builtin_cprojf128x(__coverity_complex_float128);
__coverity_complex_float16 __builtin_csinhf16(__coverity_complex_float16);
__coverity_complex_float32 __builtin_csinhf32(__coverity_complex_float32);
__coverity_complex_float64 __builtin_csinhf64(__coverity_complex_float64);
__coverity_complex_float128 __builtin_csinhf128(__coverity_complex_float128);
__coverity_complex_float32x __builtin_csinhf32x(__coverity_complex_float32x);
__coverity_complex_float64x __builtin_csinhf64x(__coverity_complex_float64x);
__coverity_complex_float128 __builtin_csinhf128x(__coverity_complex_float128);
__coverity_complex_float16 __builtin_csinf16(__coverity_complex_float16);
__coverity_complex_float32 __builtin_csinf32(__coverity_complex_float32);
__coverity_complex_float64 __builtin_csinf64(__coverity_complex_float64);
__coverity_complex_float128 __builtin_csinf128(__coverity_complex_float128);
__coverity_complex_float32x __builtin_csinf32x(__coverity_complex_float32x);
__coverity_complex_float64x __builtin_csinf64x(__coverity_complex_float64x);
__coverity_complex_float128 __builtin_csinf128x(__coverity_complex_float128);
__coverity_complex_float16 __builtin_csqrtf16(__coverity_complex_float16);
__coverity_complex_float32 __builtin_csqrtf32(__coverity_complex_float32);
__coverity_complex_float64 __builtin_csqrtf64(__coverity_complex_float64);
__coverity_complex_float128 __builtin_csqrtf128(__coverity_complex_float128);
__coverity_complex_float32x __builtin_csqrtf32x(__coverity_complex_float32x);
__coverity_complex_float64x __builtin_csqrtf64x(__coverity_complex_float64x);
__coverity_complex_float128 __builtin_csqrtf128x(__coverity_complex_float128);
__coverity_complex_float16 __builtin_ctanhf16(__coverity_complex_float16);
__coverity_complex_float32 __builtin_ctanhf32(__coverity_complex_float32);
__coverity_complex_float64 __builtin_ctanhf64(__coverity_complex_float64);
__coverity_complex_float128 __builtin_ctanhf128(__coverity_complex_float128);
__coverity_complex_float32x __builtin_ctanhf32x(__coverity_complex_float32x);
__coverity_complex_float64x __builtin_ctanhf64x(__coverity_complex_float64x);
__coverity_complex_float128 __builtin_ctanhf128x(__coverity_complex_float128);
__coverity_complex_float16 __builtin_ctanf16(__coverity_complex_float16);
__coverity_complex_float32 __builtin_ctanf32(__coverity_complex_float32);
__coverity_complex_float64 __builtin_ctanf64(__coverity_complex_float64);
__coverity_complex_float128 __builtin_ctanf128(__coverity_complex_float128);
__coverity_complex_float32x __builtin_ctanf32x(__coverity_complex_float32x);
__coverity_complex_float64x __builtin_ctanf64x(__coverity_complex_float64x);
__coverity_complex_float128 __builtin_ctanf128x(__coverity_complex_float128);
void __builtin_GOMP_taskwait_depend_nowait(void*);
#endif
#endif
/*
  Copyright (c) 2023 Synopsys, Inc. All rights reserved worldwide.
...
#pragma builtin end
#endif /* COVERITY_COMPAT_6350b46693a1a6948fad3c307ec46552 */
#endif /* __COVERITY__ */
